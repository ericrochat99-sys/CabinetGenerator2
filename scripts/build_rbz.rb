...
REQUIRED_PATHS = [
  ...
  "skilled_services/services/metadata_service.rb",
  "skilled_services/settings/project_defaults.rb",
  "skilled_services/catalog/loader.rb",
  "skilled_services/catalog/base.json",
  "skilled_services/geometry/part_builder.rb",
  "skilled_services/reports/report_service.rb",
  "skilled_services/ui/cabinet_edit_tool.rb",
